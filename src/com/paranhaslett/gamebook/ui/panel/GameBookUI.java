...
public class GameBookUI extends PanelUI {
	...
	private GameBookUI() {
		...
		btnAddSection.setIcon(new ImageIcon(GameBookUI.class.getResource("/icons/tree/section.png")));
		...
		btnAddPage.setIcon(new ImageIcon(GameBookUI.class.getResource("/icons/tree/page.png")));
		...
		lblGameBook.setIcon(new ImageIcon(GameBookUI.class.getResource("/icons/tree/gamebook.png")));
