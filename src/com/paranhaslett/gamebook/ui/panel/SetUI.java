...
public class SetUI extends PanelUI {
	...
	private SetUI() {		
		...
		lblHeading.setIcon(new ImageIcon(SetUI.class.getResource("/icons/tree/set.png")));
		      ...
		      .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
		        ...
		        .addGroup(groupLayout.createSequentialGroup()
		          ...
		          .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
		            .addGroup(groupLayout.createSequentialGroup()
		              .addComponent(textVariable, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		              .addPreferredGap(ComponentPlacement.RELATED)
		              .addComponent(lblValue)
		              .addPreferredGap(ComponentPlacement.RELATED)
		              .addComponent(textValue, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		            .addComponent(textText)
		...
		groupLayout.setVerticalGroup(
		  groupLayout.createParallelGroup(Alignment.LEADING)
		    .addGroup(groupLayout.createSequentialGroup()
		      ...
		      .addPreferredGap(ComponentPlacement.RELATED)
		      .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
		        .addComponent(textText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		        .addComponent(lblText_1))
		      .addPreferredGap(ComponentPlacement.RELATED)
		      .addComponent(lblText)
		      .addPreferredGap(ComponentPlacement.RELATED)
	...
	public void populateModel() {
	  if (textText.getText()==null||textText.getText().equals("")){
	    textText.setText("Set " + textVariable.getText() + " to " + textValue.getText());
	  }
