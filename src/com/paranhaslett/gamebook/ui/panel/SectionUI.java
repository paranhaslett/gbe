...
public class SectionUI extends PanelUI {
  ...
  private SectionUI() {
    ...
    lblHeading.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/section.png")));

    JButton btnDescription = new JButton("Add Description");
    btnDescription.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/desc.png")));
    ...
    btnSet.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/set.png")));
    ...
    btnChance.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/sm_chance.png")));
    ...
    btnChoice.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/choice.png")));
    ...
    btnIf.setIcon(new ImageIcon(SectionUI.class.getResource("/icons/tree/if.png")));
        ...
        .addGroup(groupLayout.createSequentialGroup()
          ...
          .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
            ...
            .addGroup(groupLayout.createSequentialGroup()
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addComponent(textTitle, GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE)
                .addGroup(groupLayout.createSequentialGroup()
                  .addComponent(btnIf)
                  .addPreferredGap(ComponentPlacement.RELATED)
