...
public class IfUI extends PanelUI {
  ...
  private IfUI() {
    ...
    lblHeading.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/if.png")));

    JButton btnDescription = new JButton("Add Description");
    btnDescription.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/desc.png")));
    ...
    btnSet.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/set.png")));
    ...
    btnChance.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/sm_chance.png")));
    ...
    btnChoice.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/choice.png")));
    ...
    btnIf.setIcon(new ImageIcon(IfUI.class.getResource("/icons/tree/if.png")));
            ...
            .addGroup(groupLayout.createSequentialGroup()
              ...
              .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                .addGroup(groupLayout.createSequentialGroup()
                  ...
                  .addPreferredGap(ComponentPlacement.RELATED)
                  .addComponent(textRhs, GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE))
  ...
  public void populateModel() {
    ...
    if(textField.getText()==null||textField.getText().equals("")){
      textField.setText("If " + textLhs.getText() + (String)comboBox.getSelectedItem() + textRhs.getText());
    }
