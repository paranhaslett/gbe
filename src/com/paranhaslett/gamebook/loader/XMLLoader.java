...
public class XMLLoader implements Loader {
  ...
  public void setTextElement(Document doc, Element nodeElement, String name, String value) {
    Element titleElement = doc.createElement(name);
    nodeElement.appendChild(titleElement);
    titleElement.appendChild(doc.createTextNode(value));
  }

  public void setStrs(Document doc, Element nodeElement, String name, ArrayList<String> values) {
